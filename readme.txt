...
Will write 'list query responses' to console text and 'server feed' to console as warning text.
...
rconforSquadJS.js
working draft, intended as a straight swap for squadJS/core/rcon.js
